...
const FILE_OWNERSHIP = {
  ...
  "lib/disk_space_measurement_builder.mjs": { role: "validator", concern: "independent raw disk-sample recomputation and measurement comparison", target_owner: "Runtime governance (Phase 6)" },
  "lib/disk_space_policy.mjs": { role: "validator", concern: "sealed disk-policy custody and physical-root headroom evaluation", target_owner: "Runtime governance (Phase 6)" },
  "lib/installed_inline_xbrl_probe.mjs": { role: "validator", concern: "bounded installed-host Inline-XBRL capability verification", target_owner: "Runtime governance (Phase 6)" },
  "lib/installed_runtime_identity.mjs": { role: "validator", concern: "read-only installed slot, active-pointer, promotion and rollback identity verification", target_owner: "Runtime governance (Phase 6)" },
  "lib/libreoffice_workbook_capability.mjs": { role: "validator", concern: "bounded installed-host LibreOffice functional workbook verification", target_owner: "Runtime governance (Phase 6)" },
  ...
  "lib/screen_session.mjs": { role: "canonical_writer", concern: "authenticated durable one-use Company-screen session state", target_owner: "Runtime governance (Phase 6)" },
  ...
  "lib/exact_head_package_ci.mjs": { role: "validator", concern: "exact-head package inventory, independent A/B comparison and archive-only capability proof validation", target_owner: "Release/package compiler (Phase 8)" },
  ...
  "lib/metamorphic_relations.mjs": { role: "validator", concern: "P7.4 transform families + locality verdicts read from the equation graph; compares transformed pairs, never mutates a case in place", target_owner: "Corpus and oracles (Phase 7)" },
