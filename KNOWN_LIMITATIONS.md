...
- The installed-host canary remains the sole blocked registry item. No Rogo receipt, installed-package identity, active-pointer readback, or second-fresh-session evidence exists for v3.7.5.
